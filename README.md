...
- **HAR70+ Activity Recognition** – ML/DL pipeline for wearable sensor data  
- **Blockchain Voting System** – Secure ballot casting and validation via smart contracts  
- **Mobile Social App** – React Native application with feed, auth, and notification features  
